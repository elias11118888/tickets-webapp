...
function MainComponent() {
  ...
  const handleEventClick = (event) => {
    setSelectedEventAnalytics(event);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] relative overflow-hidden">
                      ...
                      return (
                        ...
                        >
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-white hover:text-[#357AFF] transition-colors">
                              {event.title}
                            </div>
      ...
      {selectedEventAnalytics && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-white/20">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-semibold text-white">
                Event Analytics: {selectedEventAnalytics.title}
              </h3>
              <button
                onClick={() => {
                  setSelectedEventAnalytics(null);
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="text-white ml-2">
                        {new Date(
                          selectedEventAnalytics.event_date
                        ).toLocaleDateString()}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="text-white ml-2">
                        {selectedEventAnalytics.category}
                      </span>
                    </div>
                    <div>
                      ...
                      <span
                        className={`ml-2 px-2 py-1 rounded text-xs font-medium ${
                          selectedEventAnalytics.status === "approved"
                            ? "bg-green-500 text-white"
                            : selectedEventAnalytics.status === "pending"
                            ? "bg-yellow-500 text-white"
                            : "bg-red-500 text-white"
                        }`}
                      >
                        {selectedEventAnalytics.status}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xl font-bold text-white">
                          {selectedEventAnalytics.total_tickets -
                            selectedEventAnalytics.available_tickets}
                        </p>
                      </div>
                      <i className="fas fa-ticket-alt text-[#357AFF] text-xl"></i>
                    </div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                    <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-white">
                          ...
                          {(
                            (selectedEventAnalytics.total_tickets -
                              selectedEventAnalytics.available_tickets) *
                            selectedEventAnalytics.ticket_price
                          ).toFixed(2)}
                        </p>
                      </div>
                  ...
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-white/70 text-sm">Sell Rate</p>
                        <p className="text-xl font-bold text-white">
                          {(
                            ((selectedEventAnalytics.total_tickets -
                              selectedEventAnalytics.available_tickets) /
                  ...
                  <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-white font-semibold">
                          $
                          {(selectedEventAnalytics.ticket_price * 0.95).toFixed(
                            2
                          )}
                        </span>
                      </div>
